...
class WishlistService {
  ...
  static const String baseUrl = 'http://192.168.10.41:5000/api';
  ...
  static Future<bool> addToWishlist(int productId, String token) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/wishlist/wishlistadd'),
        headers: {
  ...
  static Future<List<Product>> getWishlistItems(String token) async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/wishlist/wishlistget'),
  ...
  static Future<void> removeWishlist(int cartItemId) async {
    ...
    final uri = Uri.parse(
      'http://192.168.10.41:5000/api/wishlist/wishlistdel/$cartItemId',
    );
